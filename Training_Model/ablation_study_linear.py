...
for meld in range(5):
    print(f"\n" + "="*50)
    print(f"正在執行 {meld} 副露的消融實驗 (Linear)")
    print("="*50)
    ...
    plt.title(f'[{meld} 副露] 移除單一特徵對預測聽牌準確率的影響 (Linear)', fontsize=14, fontweight='bold')
    ...
    plt.tight_layout()
    save_path = f"feature_importance_ablation_linear_meld_{meld}.png"
