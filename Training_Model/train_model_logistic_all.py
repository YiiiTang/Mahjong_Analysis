...
print(f"第一張被打出(i) 的權重: {model.coef_[0][8]:.4f}")
print(f"第二張被打出(j) 的權重: {model.coef_[0][9]:.4f}")
print(f"第三張被打出(k) 的權重: {model.coef_[0][10]:.4f}")
print(f"第四張被打出(l) 的權重: {model.coef_[0][11]:.4f}")